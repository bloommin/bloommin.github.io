...
After you clone your repository to local, new a file `Rakefile`, and add contens below. Then you can use shell command `rake newpost` to add a new post conveniently.
